			...
			<section class="404-error no-posts post cf">
				...
				<section class="post-container">
					...
					<article class="post-content cf">
						<p><?php _e( 'We apologize but something when wrong while trying to find what you were looking for. Please use the search below or the main menu to navigate to your destination.', 'capture' ); ?></p>
